...
def hotelinfocrawler(hotelid, distance):
    ...
    if count != 0:  # 若評論數量不為0則append
        ...
        temp = r1.json()
        sum = 0
        for i in range(len(temp['aboutHotel']['placesOfInterest']['placesOfInterestProperties'][0]['places'])):
            print(temp['aboutHotel']['placesOfInterest']['placesOfInterestProperties'][0]['places'][i]['name'])
            print(temp['aboutHotel']['placesOfInterest']['placesOfInterestProperties'][0]['places'][i]['distance'])
            sum += temp['aboutHotel']['placesOfInterest']['placesOfInterestProperties'][0]['places'][i]['distance']
        sum = sum/len(temp['aboutHotel']['placesOfInterest']['placesOfInterestProperties'][0]['places'])
