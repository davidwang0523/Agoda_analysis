...
# plot
l1, = plt.plot(len(staytime),list(fit1.fittedvalues) + list(fit1.forecast(5)), marker='o')


fit2 = SimpleExpSmoothing(staytime).fit(smoothing_level=0.6, optimized=False)
# plot
l2, = plt.plot(len(staytime),list(fit2.fittedvalues) + list(fit2.forecast(5)), marker='o')


fit3 = SimpleExpSmoothing(staytime).fit()
# plot
l3, = plt.plot(len(staytime),list(fit3.fittedvalues) + list(fit3.forecast(5)), marker='o')

l4, = plt.plot(len(staytime),staytime, marker='o')
